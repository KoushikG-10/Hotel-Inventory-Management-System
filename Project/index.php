                                        ...
                                        <div class="table-responsive">
                                            <table class="table">
                                                ...
                                                <?php
                                                    ...
                                                    ?>
                                                    <tr>
                                                        <td><?php echo $rows['stockprod_ID']; ?></td>
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-striped">
                                                ...
                                                <?php
                                                    ...
                                                    <tr>
                                                        <?php
                                                        if($rows['stock_quantity'] <= 50){
                                                            echo "<script>alert('Stock level for {$rows['name']} is less');</script>";
                                                            echo "<td>" .$rows['stockprod_ID']. "</td>";
                                                            echo "<td>" .$rows['name']. "</td>";
                                                            echo "<td>" .$rows['stock_quantity']. "</td>";
                                                        }
                                                        ?>
                                                    </tr>
                                                    <?php
        ...
        <div class="quixnav">
            <div class="quixnav-scroll">
                <ul class="metismenu" id="menu">
                    ...
                    <li><a href="purchase.php"><i class="icon icon-chart-bar-33"></i><span class="nav-text">Purchase</span></a>
                    ...
                    <li><a class="has-arrow"href="javascript:void()"aria-expanded="false"><i class="icon icon-single-copy-06"></i><span class="nav-text">Reports</span></a>
                        <ul aria-expanded="false">
